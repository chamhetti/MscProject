...
import lk.ac.ucsc.oms.messaging_protocol_json.impl.beans.ver1.inquiry.OrderSearchResponseBean;
import com.google.gson.annotations.SerializedName;


public class OrderSearchResponseEnvelope implements Envelope {

    @SerializedName("HED")
    private HeaderImpl header;
    @SerializedName("DAT")
    private OrderSearchResponseBean body;
    ...
    public void setBody(Object body) {
        this.body = (OrderSearchResponseBean) body;
    }
