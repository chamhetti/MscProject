...
import lk.ac.ucsc.oms.messaging_protocol_json.impl.beans.ver1.inquiry.OrderDetailsResponseBean;
import com.google.gson.annotations.SerializedName;


public class OrderDetailsResponseEnvelope implements Envelope {

    @SerializedName("HED")
    private HeaderImpl header;
    @SerializedName("DAT")
    private OrderDetailsResponseBean body;
    ...
    public void setBody(Object body) {
        this.body = (OrderDetailsResponseBean) body;
    }
